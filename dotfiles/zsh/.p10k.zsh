# Generated by Powerlevel10k configuration wizard on 2024-10-14 at 18:02 PDT.
...
() {
  ...
  # Prompt colors.
  local grey="$GUI_COMMENT_GREY"
  local red="$GUI_RED"
  local yellow="$GUI_DARK_YELLOE"
  local blue="$GUI_BLUE"
  local magenta="$GUI_PURPLE"
  local cyan="$GUI_CYAN"
  local white="$GUI_WHITE"
  local green="$GUI_GREEN"
