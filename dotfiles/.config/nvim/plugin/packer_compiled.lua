...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'bufferline.nvim', 'lualine.nvim', 'todo-comments.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'nvim-lspconfig'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
