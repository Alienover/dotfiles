...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'bufferline.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim', 'lualine.nvim', 'nvim-autopairs', 'todo-comments.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'editorconfig-vim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'vim-vsnip', 'cmp-buffer', 'cmp-calc', 'cmp-emoji', 'cmp-path', 'cmp-vsnip'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
