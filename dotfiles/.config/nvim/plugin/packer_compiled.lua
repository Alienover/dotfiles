...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'winbar.nvim', 'telescope.nvim', 'lualine.nvim', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'lspsaga.nvim', 'todo-comments.nvim', 'nvim-autopairs', 'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-nvim-lsp-signature-help', 'cmp-path', 'cmp-buffer', 'cmp-calc', 'cmp-emoji'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au CursorMoved * ++once lua require("packer.load")({'vim-matchup', 'vim-illuminate'}, { event = "CursorMoved *" }, _G.packer_plugins)]]
