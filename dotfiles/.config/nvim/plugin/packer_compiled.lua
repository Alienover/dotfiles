...
_G.packer_plugins = {
  ...
  ["nvim-lsp-installer"] = {
    ...
    url = "/Users/jiarong/Documents/myself/nvim-lsp-installer"
  },
  ["nvim-lspconfig"] = {
...
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-vsnip', 'vim-vsnip', 'cmp-emoji', 'cmp-buffer', 'cmp-calc'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-autopairs', 'gitsigns.nvim', 'bufferline.nvim', 'nvim-colorizer.lua', 'lualine.nvim', 'todo-comments.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
