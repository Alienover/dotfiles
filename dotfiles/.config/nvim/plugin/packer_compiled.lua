...
_G.packer_plugins = {
  ...
  ["copilot.vim"] = {
    loaded = true,
    path = "/Users/jiarong/.local/share/nvim/site/pack/packer/start/copilot.vim",
  ...
  ["lspsaga.nvim"] = {
    ...
    url = "/Users/jiarong/Documents/myself/lspsaga.nvim"
  },
  ["lua-dev.nvim"] = {
    loaded = true,
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-autopairs', 'todo-comments.nvim', 'gitsigns.nvim', 'lualine.nvim', 'bufferline.nvim', 'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-path', 'cmp-vsnip', 'vim-vsnip', 'cmp-buffer', 'cmp-emoji', 'cmp-calc'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
