...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-autopairs', 'todo-comments.nvim', 'gitsigns.nvim', 'bufferline.nvim', 'lualine.nvim', 'nvim-colorizer.lua'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
