...
_G.packer_plugins = {
  ...
  ["lspsaga.nvim"] = {
    ...
    loaded = true,
    path = "/Users/jiarong/.local/share/nvim/site/pack/packer/start/lspsaga.nvim",
  ...
  ["nvim-lspconfig"] = {
    ...
    loaded = true,
    path = "/Users/jiarong/.local/share/nvim/site/pack/packer/start/nvim-lspconfig",
...
try_loadstring("\27LJ\2\n2\0\0\3\0\2\0\0046\0\0\0'\2\1\0B\0\2\1K\0\1\0\23config/saga-config\frequire\0", "config", "lspsaga.nvim")
...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'bufferline.nvim', 'nvim-autopairs', 'gitsigns.nvim', 'todo-comments.nvim', 'nvim-colorizer.lua', 'lualine.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
