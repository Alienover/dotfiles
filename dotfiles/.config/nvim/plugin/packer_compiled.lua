...
vim.cmd [[au VimEnter * ++once lua require("packer.load")({'lualine.nvim', 'telescope.nvim', 'bufferline.nvim'}, { event = "VimEnter *" }, _G.packer_plugins)]]
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-autopairs', 'todo-comments.nvim', 'nvim-colorizer.lua', 'vim-illuminate', 'gitsigns.nvim', 'lspsaga.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
vim.cmd [[au BufEnter * ++once lua require("packer.load")({'editorconfig-vim'}, { event = "BufEnter *" }, _G.packer_plugins)]]
vim.cmd [[au InsertEnter * ++once lua require("packer.load")({'cmp-calc', 'cmp-path', 'cmp-buffer', 'cmp-emoji', 'cmp-nvim-lsp-signature-help'}, { event = "InsertEnter *" }, _G.packer_plugins)]]
