...
vim.cmd [[au BufReadPre * ++once lua require("packer.load")({'nvim-lspconfig', 'lualine.nvim', 'todo-comments.nvim', 'bufferline.nvim', 'nvim-colorizer.lua', 'gitsigns.nvim'}, { event = "BufReadPre *" }, _G.packer_plugins)]]
